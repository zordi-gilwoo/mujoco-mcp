...
async def demo_mcp_menagerie():
    ...
    try:
        ...
        try:
            ...
            scene_result = await client.call_tool("create_scene", {
                "scene_type": "pendulum"
            })
            ...
            # Step simulation
            step_result = await client.call_tool("step_simulation", {
                "model_id": "pendulum",
                "steps": 5
            })
            ...
            # Get state
            state_result = await client.call_tool("get_state", {
                "model_id": "pendulum"
            })
            print("✅ Retrieved simulation state")
            state_preview = str(state_result)[:100] + "..." if len(str(state_result)) > 100 else str(state_result)
            ...
            try:
                ...
                if models_data.get('models'):
                    ...
                    if all_models:
                        ...
                        # Validate the model
                        validation_result = await client.call_tool("validate_menagerie_model", {
                            "model_name": random_model
                        })
                        print(f"   🔬 Validation: {validation_result}")

                        # Try to create scene with the model
                        menagerie_scene_result = await client.call_tool("create_menagerie_scene", {
                            "model_name": random_model,
