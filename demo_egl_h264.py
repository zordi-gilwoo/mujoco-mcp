...
async def demo_egl_rendering():
    ...
    result = await handle_call_tool('enable_egl_rendering', {
        'model_id': 'pendulum',
        'width': 640,
        'height': 480
    })
    ...
    result = await handle_call_tool('render_egl_frame', {
        'model_id': 'pendulum',
        'width': 640,
        'height': 480
    })
...
async def demo_h264_encoding():
    ...
    result = await handle_call_tool('setup_h264_encoder', {
        'model_id': 'pendulum',
        'width': 320,
        'height': 240,
        'fps': 10,
...
async def demo_performance_comparison():
    ...
    for i in range(10):
        ...
        await handle_call_tool('step_simulation', {
            'model_id': 'pendulum',
            'steps': 5
        })
