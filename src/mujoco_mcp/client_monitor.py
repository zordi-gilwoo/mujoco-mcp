...
class ClientMonitor:
    ...
    def estimate_max_clients(self) -> Dict[str, Any]:
        ...
        try:
            ...
            max_clients = min(
                max_clients_memory, max_clients_ports, max_clients_cpu, 50
            )  # Hard cap at 50
            ...
            return {"estimated_max_clients": 10, "error": str(e)}  # Fallback conservative estimate
    ...
    async def get_monitoring_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "health": {
                "status": (
                    "healthy"
                    if session_stats["active_sessions"]
                    < capacity_estimate["estimated_max_clients"] * 0.8
                    else "warning"
                ),
                "utilization_percent": round(
                    (session_stats["active_sessions"] / capacity_estimate["estimated_max_clients"])
                    * 100,
                    1,
                ),
            },
