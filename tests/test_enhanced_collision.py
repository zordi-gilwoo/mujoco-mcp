...
class TestQuaternionMath:
    ...
    def test_bbox_rotation_transform(self):
        ...
        pose = Pose(position=np.array([1, 2, 3]), orientation=np.array([0, 0, 0, 1]))
        ...
        rotated_pose = Pose(position=np.array([0, 0, 0]), orientation=z_45_quat)
...
class TestRotationAwareAABB:
    ...
    def test_rotation_aware_aabb_creation(self):
        ...
        no_rotation_pose = Pose(position=np.array([1, 2, 3]), orientation=np.array([0, 0, 0, 1]))
    ...
    def test_overlap_volume_calculation(self):
        ...
        aabb1 = RotationAwareAABB(min_coords=np.array([0, 0, 0]), max_coords=np.array([2, 2, 2]))
        aabb2 = RotationAwareAABB(min_coords=np.array([1, 1, 1]), max_coords=np.array([3, 3, 3]))
        ...
        aabb3 = RotationAwareAABB(min_coords=np.array([5, 5, 5]), max_coords=np.array([6, 6, 6]))
    ...
    def test_surface_contact_area(self):
        ...
        aabb1 = RotationAwareAABB(min_coords=np.array([0, 0, 0]), max_coords=np.array([2, 2, 1]))
...
class TestPhysicsCollisionValidator:
    ...
    def test_collision_check_xml_generation(self):
        ...
        scene_dict = {
            "objects": [
                {"object_id": "box1", "object_type": "box_small", "constraints": []},
                {"object_id": "box2", "object_type": "box_small", "constraints": []},
            ]
        }

        scene = SceneDescription(**scene_dict)
        poses = {
            "box1": Pose(position=np.array([0, 0, 0]), orientation=np.array([0, 0, 0, 1])),
            "box2": Pose(position=np.array([1, 0, 0]), orientation=np.array([0, 0, 0, 1])),
        }
