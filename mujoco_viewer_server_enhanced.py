...
class ModelViewer:
    ...
    def __init__(self, model_id: str, model_source: str):
        ...
        try:
            ...
            logger.error(f"Failed to create ModelViewer for {model_id}: {e}")
            self.cleanup()
            raise
    ...
    def _simulation_loop(self):
        ...
        try:
            ...
            logger.error(f"Simulation loop error for {self.model_id}: {e}")
        finally:
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error getting state for {self.model_id}: {e}")
            return {"error": str(e)}
    ...
    def set_joint_positions(self, positions: List[float]) -> bool:
        ...
        try:
            ...
            logger.error(f"Error setting joint positions for {self.model_id}: {e}")
            return False
    ...
    def reset(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error resetting {self.model_id}: {e}")
            return False
    ...
    def cleanup(self):
        ...
        try:
            ...
            logger.error(f"Error during cleanup of {self.model_id}: {e}")
