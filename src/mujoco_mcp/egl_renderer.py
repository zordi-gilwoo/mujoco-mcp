        ...
        with EGLContext(64, 64):
            ...
            try:
                ...
                info.update({
                    ...
                    "egl_version": f"{major_version}.{minor_version}" if major_version else "Unknown"
                })
...
def create_egl_renderer(model: mujoco.MjModel, width: int = 640, height: int = 480) -> Optional[EGLRenderer]:
