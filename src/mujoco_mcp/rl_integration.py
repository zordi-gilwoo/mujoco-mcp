...
class ReachingTaskReward(TaskReward):
    ...
    def compute_reward(
        ...
        total_reward = distance_reward + improvement_reward + success_reward + control_penalty
...
class BalancingTaskReward(TaskReward):
    ...
    def compute_reward(
        ...
        total_reward = upright_reward + velocity_penalty + control_penalty
...
class WalkingTaskReward(TaskReward):
    ...
    def compute_reward(
        ...
        total_reward = velocity_reward + stability_penalty + energy_penalty + height_reward
